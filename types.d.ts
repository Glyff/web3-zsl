...
export declare class Zsl {
  ...
  createShieldedTransfer(
    hro_1: string, sk_1: string, value_1: Number, treeIndex_1: string, authPath_1: string,
    hro_2: string, sk_2: string, value_2: Number, treeIndex_2: string, authPath_2: string,
